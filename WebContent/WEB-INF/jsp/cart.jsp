		...
		<div class="span24">
			<div class="step step1">
				...
				<table>
					...
					<s:iterator var="cartItem" value="#session.cart.cartItems">
						...
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/cart_removeCartItem.action?pid=<s:property value="#cartItem.product.pid"/>" class="delete">删除</a>
							</td>
						</tr>
					</s:iterator>
				</tbody></table>
				...
				<div class="bottom">
					...
					<a href="${pageContext.request.contextPath}/order_createOrder.action" id="submit" class="submit">提交订单</a>
				</div>
		</div>
	</s:if>
	<s:else>
		<span><h3>亲！您还没有添加商品哟！</h3></span>
	</s:else>
