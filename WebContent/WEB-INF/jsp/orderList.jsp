				...
				<table>
					...
					<tr>
						...
						<s:iterator  var="orderItem" value="#order.orderItems">
							<tr>
								<td width="60">
									<input type="hidden" name="id" value="<s:property value="#orderItem.product.pid"/>"/>
								...
								<td class="quantity" width="60">
									<span> <s:property value="#orderItem.count"/></span> 
								</td>
								<td width="140">
					...
					<td colspan="5">
						<div class="pagination">
								...
								<s:if test="pageBean.page != 1">
									...
									<a class="firstPage"
										href="${pageContext.request.contextPath}/order_findByUid?page=1"></a>
